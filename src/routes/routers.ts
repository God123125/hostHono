...
import productDocRoute from "./admin/product-document.route.js";
import storeCateDocRoute from "./admin/store-categories-document.route.js";
import storeDocRoute from "./admin/store-document.route.js";
import dashboardRoute from "./admin/dashboard.route.js";
import merchantRoute from "./admin/merchant.route.js";
